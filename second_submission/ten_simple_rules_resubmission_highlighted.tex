...
\begin{figure}[h]
  ...
  \fbox{\includegraphics[width=0.99\linewidth]{figures/timeline_linewidth_rot.pdf}}
...
Choosing collaborators represents the first fundamental step for collaboration between wet-lab and dry-lab researchers. {\color{red} \sout{Without an aligned choice of collaborating labs,} In particular, we suggest to carefully discuss \sout{ discrepancies in} scientific interests and values with potential collaborators; discrepancies are harder to navigate later on.} Two questions should be considered. First, is there an adequate scientific match in the collaboration (e.g., for us, analysis of a certain type of omic data)? That is, do the groups complement each other well in terms of scientific interests and skills? Second, are (research) values between groups aligned? Meaning, do both groups have broadly similar ideas of how research is to be conducted day-to-day? For example, is excellence defined as a {\color{red} \sout{CNS} Cell/Nature/Science} paper, or is it robust and high quality science?
...
{\color{red} Actionable items: openly discuss expectations (Table~\ref{form}); be transparent and agree on funding sources (i.e. ideologically loaded private foundations).}
...
Actionable items: Follow the FAIR guidelines (\url{https://www.go-fair.org/fair-principles/}); define file naming policies; be aware of sensitive data handling regulations {\color{red} in your country (e.g.} GDPR in Europe \cite{shabani2019reidentifiability,party2011advice}, {\color{red} PIPEDA in Canada \cite{phillips2018international}, HIPAA in the US \cite{phillips2018international}}); follow good practices for spreadsheets \cite{broman2018data}.
...
Actionable items: add explanatory comments to {\color{red}\sout{your} the} analysis code; do not shy away from asking what you do not understand; commit to answering basic and advanced questions about the analysis.
...
\input{expectations_table_resubmission_highlighted}
