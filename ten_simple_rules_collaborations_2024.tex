...
\\
$^1$ Department of Molecular Life Sciences, University of Zurich, Winterthurerstrasse 190, CH-8057 Zurich, Switzerland \\
$^2$ SIB Swiss Institute of Bioinformatics \\
$^3$ Co-correspondence \texttt{\{mark.robinson,izaskun.mallona\}@mls.uzh.ch} \\
...
Other short actionable items and tools: Follow the FAIR guidelines (\url{https://www.go-fair.org/fair-principles/}); define file naming policies; be aware of sensitive data handling regulations \cite{shabani2019reidentifiability,party2011advice}; follow spreadsheet guidelines\cite{broman2018data}.
...
this & is the expectations table!
